...
var ImgError = /** @class */ (function (_super) {
    __extends(ImgError, _super);
    function ImgError(event) {
        var _this = _super.call(this, 'Image error') || this;
        _this.event = event;
        return _this;
    }
    return ImgError;
...
var Image = /** @class */ (function (_super) {
    ...
    function Image(props) {
        ...
        _this._imgOnError = function (event) {
            _this._onError(new ImgError(event));
        };
